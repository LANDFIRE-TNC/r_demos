...
## North Central WA Havilla, WA on the Okanagan-Wenatchee NF
## We created a small working example here with a subset of the data.  you can replace this .gdb, with the LANDFIRE gdb and work with that.  
