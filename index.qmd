...
See map of LANDFIRE Map Zones [here](https://landfirereview.org/IMG/USmapzones-v1_July2015.jpg).  Note: some datasets are compiled by Map Zone so maps or analysis that crosses multiple may result in seamlines or other complications.  Contact us to discuss at [landfire@tnc.org](mailto:landfire@tnc.org){target="blank"}. 
...
1. Check your R, R-Studio and package versions. We recommend running the most current version of R or R-Studio. [See what we used](about.qmd){target="blank"} 
...
**Project Team:** [USGS EROS](https://www.usgs.gov/centers/eros){target="blank"}, EROS Technical Support Services Contract (KBR), [The Nature Conservancy](https://www.nature.org/en-us/){target="blank"}, [USDA Forest Service (Rocky Mountain Research Station) RMRS](https://research.fs.usda.gov/rmrs){target="blank"}, and [Forest Inventory & Analysis (FIA)](https://research.fs.usda.gov/programs/fia){target="blank"} 

**Partners:** [USGS Gap Analysis](https://www.usgs.gov/programs/gap-analysis-project){target="blank"}, [USGS National Land Imaging Program](https://www.usgs.gov/programs/national-land-imaging-program){target="blank"} 
