...
*(Need help deciding? Check our cheatsheet here)*  
...
*(Not sure how to do that? Try our tutorial)*  
...
::: {.column width="60%"}
## 🔍 Making Connections
![](assets/connect.png){fig-alt="4 boxes LANDFIRE Data, R code Demos (you are here), Tinker around, Insights and Innovations." width="100%"}
::: 
