...
Do you work with [LANDFIRE](https://landfire.gov){target="blank"} data and want a faster way to dig into ecological patterns across your landscape? You’re in the right place.
...
See map of LANDFIRE Map Zones [here](https://landfirereview.org/IMG/USmapzones-v1_July2015.jpg){target="blank"}.  Note: some datasets are compiled by Map Zone so maps or analysis that crosses multiple may result in seamlines or other complications.  Contact us to discuss at [landfire@tnc.org](mailto:landfire@tnc.org){target="blank"}. 
