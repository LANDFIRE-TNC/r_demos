...
We use LANDFIRE's Biophysical Settings (BpS) data to help us understand the potential of a landscape.  

> *Biophysical Settings represent the vegetation system that may have been dominant on the landscape prior to Euro-American settlement. These models are based on a combination of the current environment and an approximation of the historical disturbance regime.* [Read more](https://landfire.gov/bps.php){target="blank"}.
...
1. Set up a new R-Studio project 
2. Create two directories, "inputs" and "outputs"
3. Download the following and place into the "inputs" directory (click Download button to the right of the "Raw" button in the top right corner)
    * zipped [shapefile](https://github.com/LANDFIRE-TNC/r_demos/blob/main/inputs/map_zone_35.zip) of our demonstration area (unzip into "inputs" directory)
    * [.csv file of BpS attributes](https://github.com/LANDFIRE-TNC/r_demos/blob/main/inputs/LF20_BPS_220.csv) 

**Or, download the Git [Repo](https://github.com/LANDFIRE-TNC/r_demos.git)**.  
