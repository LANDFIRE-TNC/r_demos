...
- Download and prepare LANDFIRE data using the [rlandfire](https://github.com/bcknr/rlandfire){target="blank"} package (developed by Mark Buckner), including setting up a project environment and managing spatial data files. 
...
You should see a set of files with "landfire" in the name. Next go to the [Prepare rasters](prep_rasters.html){target="blank"} page to learn how to load them into R, clip/mask and view them. 


## More resources

* Mark Buckner's [rlandfire](https://github.com/bcknr/rlandfire){target="blank"} site also has a useful tutorial. 
* There is also a Python package for downloading LANDFIRE data, [landfire-python](https://landfire-python.firesci.io/en/latest/){target="blank"}. If you try this please [let us know](mailto:landfire@tnc.org){target="blank"}!
